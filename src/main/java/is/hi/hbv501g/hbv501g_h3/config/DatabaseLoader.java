...
public class DatabaseLoader {
    ...
    CommandLineRunner initDatabase(UserService userService, PatternRepository patternRepository) {
        return args -> {
            ...
            patternRepository.save(new KnittingPattern("testPattern2", false, "121212,121212,121212", arounr));
            ...
            patternRepository.save(new KnittingPattern("AAAA", true, "121212,121212,121212", user1));
            patternRepository.save(new KnittingPattern("AAAA", true, "121212,121212,121212", user1));
            patternRepository.save(new KnittingPattern("AAAA", true, "121212,121212,121212", user1));
            patternRepository.save(new KnittingPattern("AAAA", true, "121212,121212,121212", user1));
            patternRepository.save(new KnittingPattern("AAAA", true, "121212,121212,121212", user1));
